...
class Settings(Node):
    ...
    def _ready(self):
        ...
        self.master_slider.connect(
            "value_changed", self, "_master_volume_changed")
        self.music_slider.connect(
            "value_changed", self, "_music_volume_changed")
    ...
    def update_settings(self):
        ...
        self.fullscreen_box.pressed = self.settings_dict.get(
            "fullscreen", False)
